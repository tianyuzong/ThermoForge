...
LABELS = {
    ...
    'Material': dict(name='材料名称', k='导热系数 (W/(m·K))', rho='密度 (kg/m³)', cp='比热容 (J/(kg·K))',
        thermal_expansion_CTE_per_K='线膨胀系数 (1/K)', phase_change='相变'),
    ...
    'Heat': dict(name='热源名称', source_type='热源类型', placement='放置方式', power_W='总功率 (W)',
    ...
    'Cooling': dict(name='散热区名称', h='局部换热系数 (W/(m²·K))', ambient_C='局部环境温度 (°C)',
